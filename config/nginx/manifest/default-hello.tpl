...
<div class="wrap">
  ...
  <div class="guide text-justify">
    <p>
      ...
      web server after installation on this systems. This host using PHP version
    ...
    <p>
      ...
      persists, please contact the <a href="mailto:ripandi@pm.me">system administrator</a>.
    </p>
