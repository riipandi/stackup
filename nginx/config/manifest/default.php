  ...
  <body>
    <div class="container">
      <div class="content">
        <h1>Hello there!</h1>
        <p>
          This is the default page for <?=$_SERVER['HTTP_HOST'];?>. This page
          used to test the correct operation of the web server  installation
          and you are using PHP v<?=(float)phpversion();?>. If you can read
          this page, it means that the web server installed and working
          properly. You should replace this index file before continuing
