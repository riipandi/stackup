<?php if (!empty($_GET['p']) && $_GET['p'] == 'info') { phpinfo(); } else { ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="wrap">
	...
	<div class="guide text-justify">
		<p>
			<a href="/<?='?p=info'?>">This is</a> the default welcome page used to 
			test the correct operation of the web server after installation on this systems. If 
			you can read this page, it means that the web server installed and working properly. 
			You should <b>replace this file</b> (located at <tt><?=realpath(__FILE__)?></tt>) 
			before continuing to operate your web server.
          </p>
          <p>
			  The web server software is running but no content has been added, yet. If you are 
			  a normal user of this web site and don't know what this page is about, this probably 
			  means that the site is currently unavailable due to maintenance. If the problem 
			  persists, please contact the <a href="mailto:arsitech@protonmail.com">system administrator</a>.
          </p>
          <p>Please report bugs specific to modules to respective packages, not to the web server itself.</p>
		<p class="previous text-center">&laquo;&nbsp;<a href="javascript:window.history.back();">back to previous page</a>&nbsp;&raquo;</p>
	</div>
